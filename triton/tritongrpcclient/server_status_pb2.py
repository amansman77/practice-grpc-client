...
_INFERREQUESTSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='compute_input', full_name='nvidia.inferenceserver.InferRequestStats.compute_input', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='compute_infer', full_name='nvidia.inferenceserver.InferRequestStats.compute_infer', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='compute_output', full_name='nvidia.inferenceserver.InferRequestStats.compute_output', index=6,
...
_INFERREQUESTSTATS.fields_by_name['compute_input'].message_type = _STATDURATION
_INFERREQUESTSTATS.fields_by_name['compute_infer'].message_type = _STATDURATION
_INFERREQUESTSTATS.fields_by_name['compute_output'].message_type = _STATDURATION
...
StatDuration = _reflection.GeneratedProtocolMessageType('StatDuration', (_message.Message,), {
...
StatusRequestStats = _reflection.GeneratedProtocolMessageType('StatusRequestStats', (_message.Message,), {
...
HealthRequestStats = _reflection.GeneratedProtocolMessageType('HealthRequestStats', (_message.Message,), {
...
ModelControlRequestStats = _reflection.GeneratedProtocolMessageType('ModelControlRequestStats', (_message.Message,), {
...
SharedMemoryControlRequestStats = _reflection.GeneratedProtocolMessageType('SharedMemoryControlRequestStats', (_message.Message,), {
...
RepositoryRequestStats = _reflection.GeneratedProtocolMessageType('RepositoryRequestStats', (_message.Message,), {
...
InferRequestStats = _reflection.GeneratedProtocolMessageType('InferRequestStats', (_message.Message,), {
...
ModelReadyStateReason = _reflection.GeneratedProtocolMessageType('ModelReadyStateReason', (_message.Message,), {
...
ModelVersionStatus = _reflection.GeneratedProtocolMessageType('ModelVersionStatus', (_message.Message,), {
  ...
  'InferStatsEntry' : _reflection.GeneratedProtocolMessageType('InferStatsEntry', (_message.Message,), {
...
ModelStatus = _reflection.GeneratedProtocolMessageType('ModelStatus', (_message.Message,), {
  ...
  'VersionStatusEntry' : _reflection.GeneratedProtocolMessageType('VersionStatusEntry', (_message.Message,), {
...
SharedMemoryRegion = _reflection.GeneratedProtocolMessageType('SharedMemoryRegion', (_message.Message,), {

  'SystemSharedMemory' : _reflection.GeneratedProtocolMessageType('SystemSharedMemory', (_message.Message,), {
  ...
  'CudaSharedMemory' : _reflection.GeneratedProtocolMessageType('CudaSharedMemory', (_message.Message,), {
...
ServerStatus = _reflection.GeneratedProtocolMessageType('ServerStatus', (_message.Message,), {
  ...
  'ModelStatusEntry' : _reflection.GeneratedProtocolMessageType('ModelStatusEntry', (_message.Message,), {
...
SharedMemoryStatus = _reflection.GeneratedProtocolMessageType('SharedMemoryStatus', (_message.Message,), {
...
ModelRepositoryIndex = _reflection.GeneratedProtocolMessageType('ModelRepositoryIndex', (_message.Message,), {
...
_SHAREDMEMORYCONTROLREQUESTSTATS._options = None
