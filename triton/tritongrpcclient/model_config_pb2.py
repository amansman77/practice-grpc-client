...
_MODELQUEUEPOLICY_TIMEOUTACTION = _descriptor.EnumDescriptor(
  name='TimeoutAction',
  full_name='nvidia.inferenceserver.ModelQueuePolicy.TimeoutAction',
  filename=None,
  file=DESCRIPTOR,
  values=[
    _descriptor.EnumValueDescriptor(
...
_MODELQUEUEPOLICY = _descriptor.Descriptor(
  ...
  full_name='nvidia.inferenceserver.ModelQueuePolicy',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='timeout_action', full_name='nvidia.inferenceserver.ModelQueuePolicy.timeout_action', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_timeout_microseconds', full_name='nvidia.inferenceserver.ModelQueuePolicy.default_timeout_microseconds', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='allow_timeout_override', full_name='nvidia.inferenceserver.ModelQueuePolicy.allow_timeout_override', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_queue_size', full_name='nvidia.inferenceserver.ModelQueuePolicy.max_queue_size', index=3,
...
_MODELDYNAMICBATCHING_PRIORITYQUEUEPOLICYENTRY = _descriptor.Descriptor(
  ...
  full_name='nvidia.inferenceserver.ModelDynamicBatching.PriorityQueuePolicyEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='nvidia.inferenceserver.ModelDynamicBatching.PriorityQueuePolicyEntry.key', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='nvidia.inferenceserver.ModelDynamicBatching.PriorityQueuePolicyEntry.value', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MODELDYNAMICBATCHING = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='priority_levels', full_name='nvidia.inferenceserver.ModelDynamicBatching.priority_levels', index=3,
      number=4, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_priority_level', full_name='nvidia.inferenceserver.ModelDynamicBatching.default_priority_level', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='default_queue_policy', full_name='nvidia.inferenceserver.ModelDynamicBatching.default_queue_policy', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='priority_queue_policy', full_name='nvidia.inferenceserver.ModelDynamicBatching.priority_queue_policy', index=6,
...
ModelDynamicBatching = _reflection.GeneratedProtocolMessageType('ModelDynamicBatching', (_message.Message,), {
  ...
  'PriorityQueuePolicyEntry' : _reflection.GeneratedProtocolMessageType('PriorityQueuePolicyEntry', (_message.Message,), {
    ...
    '__module__' : 'model_config_pb2'
    # @@protoc_insertion_point(class_scope:nvidia.inferenceserver.ModelDynamicBatching.PriorityQueuePolicyEntry)
    })
  ,
